...
function RegisterPage() {
  ...
  const mutation = useMutation({
    ...
    onError: (e) => setError((e == null ? void 0 : e.message) || "Registration failed")
  });
  const onSubmit = (e) => {
    e.preventDefault();
  ...
  return /* @__PURE__ */ jsxs("div", { className: "p-4 max-w-md mx-auto", children: [
    /* @__PURE__ */ jsx("h1", { className: "text-2xl font-semibold mb-4", children: "Create Account" }),
    /* @__PURE__ */ jsxs("form", { className: "flex flex-col gap-3", onSubmit, children: [
      /* @__PURE__ */ jsx("input", { name: "username", placeholder: "Username", className: "border rounded p-2", required: true }),
      ...
      /* @__PURE__ */ jsx("button", { type: "submit", className: "px-4 py-2 bg-blue-600 text-white rounded disabled:opacity-50", disabled: mutation.isPending, children: mutation.isPending ? "Creating..." : "Register" }),
      error && /* @__PURE__ */ jsx("p", { className: "text-sm text-red-600", children: error })
    ] }),
    /* @__PURE__ */ jsxs("p", { className: "text-sm mt-3", children: [
      "Have an account?",
      " ",
      /* @__PURE__ */ jsx(Link, { to: "/auth/login", className: "text-blue-600 underline", children: "Login" })
    ] })
  ] });
}

export { RegisterPage as component };
//# sourceMappingURL=auth.register-CWBzep0I.mjs.map
