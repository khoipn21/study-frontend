...
import { Bot, User, Copy, ThumbsUp, ThumbsDown, ExternalLink, Code2 } from 'lucide-react'
import { Button } from '@/components/ui/button'
import { ChatMessage as ChatMessageType } from '@/lib/ai-chat'
  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        ...
        {/* Suggestions */}
        {isAssistant && message.metadata?.suggestions && message.metadata.suggestions.length > 0 && (
          <div className="space-y-2">
            <div className="text-xs font-medium text-muted-foreground">Ask me:</div>
            <div className="flex flex-wrap gap-2">
