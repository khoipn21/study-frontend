...
const GooeyNav: React.FC<GooeyNavProps> = ({
  ...
  useEffect(() => {
    ...
    const activeLi = liElements[activeIndex] as HTMLElement | undefined
    if (activeLi) {
      updateEffectPosition(activeLi)
      textRef.current?.classList.add('active')
    }
    const resizeObserver = new ResizeObserver(() => {
      const currentLiElements = navRef.current?.querySelectorAll('li')
      const currentActiveLi = currentLiElements?.[activeIndex] as
        | HTMLElement
        | undefined
      if (currentActiveLi) {
